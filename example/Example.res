...
module Constants = Reasongl.Constants
...
let window = Gl.Window.init(~screen="hi", ~argv=Sys.argv)
...
Gl.clear(~context, ~mask=lor(Constants.color_buffer_bit, Constants.depth_buffer_bit))
